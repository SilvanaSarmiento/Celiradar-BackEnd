...
let LugaresController = class LugaresController {
    ...
    async getOne(id) {
        ...
        if (!lugar) {
            throw new common_1.NotFoundException(`El lugar con ID ${id} no existe`);
        }
        return lugar;
    }
    async create(body) {
...
], LugaresController.prototype, "getAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], LugaresController.prototype, "getOne", null);
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], LugaresController.prototype, "delete", null);
